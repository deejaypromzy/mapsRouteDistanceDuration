package putuguna.com.mapsnomatrix.activity;
...
import putuguna.com.mapsnomatrix.Constant;
import putuguna.com.mapsnomatrix.R;
import putuguna.com.mapsnomatrix.Utils;
import putuguna.com.mapsnomatrix.helper.DirectionsJSONParser;
...
public class ViewRouteActivity extends FragmentActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detail.setText("Jarak Tempat : " + distance + ", Lamanya : " + duration);
...
/**
 * http://stackoverflow.com/questions/21154758/how-to-draw-path-between-2-points-on-google-map
 ...
 *
 * for url get direction
     * http://maps.googleapis.com/maps/api/directions/json?origin=-8.60817452,115.18287919&destination=-8.7208,115.1692&sensor=false&mode=driving&alternatives=true
 */
